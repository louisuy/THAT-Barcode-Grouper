...
import { Archive, FileSpreadsheet, FolderOpen, Play, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function App() {
    ...
    const handleProcess = async () => {
        ...
        try {
            const result = await (window as any).api.organize({ excelPath, folderPath });
            if (result.success) {
